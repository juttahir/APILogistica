...
abstract class StateOrderExit {
    ...
    public function cancelOrder() {
        ...
        /* Histórico */
        (new History(self::$orderExit))->description("Cancelou o Pedido")->save();
    ...
    public function breakApartOrder() {
        ...
        /* Histórico */
        (new History(self::$orderExit))->description("Liberou o pedido para separação")->save();
    ...
    public function sendToConference() {
        ...
        /* Histórico */
        (new History(self::$orderExit))->description("Liberou o pedido para conferência")->save();
    ...
    public function checked() {
        ...
        /* Histórico */
        (new History(self::$orderExit))->description("Concluiu a Conferência")->save();
    ...
    public function complete() {
        ...
        if(self::$orderExit->hasStatusItems(OrderItemExits::status(StateOrderExitItemTransport::class))){
            return $this->back('Você precisa concluir todos os itens',true);
        }
        ...
        /* Histórico */
        (new History(self::$orderExit))->description("Concluiu o Pedido")->save();
